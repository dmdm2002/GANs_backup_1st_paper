...
for n_depth in range(1, 7):
  ...
  # tf.keras.utils.plot_model(pgan.generator, to_file=f'Z:/Iris_dataset/nd_labeling_iris_data/PGGAN/1-fold/generator_{n_depth}_fade_in.png', show_shapes=True)
  # tf.keras.utils.plot_model(pgan.discriminator, to_file=f'Z:/Iris_dataset/nd_labeling_iris_data/PGGAN/1-fold/discriminator_{n_depth}_fade_in.png', show_shapes=True)
  ...
  # tf.keras.utils.plot_model(pgan.generator, to_file=f'Z:/Iris_dataset/nd_labeling_iris_data/PGGAN/1-fold/generator_{n_depth}_stabilize.png', show_shapes=True)
  # tf.keras.utils.plot_model(pgan.discriminator, to_file=f'Z:/Iris_dataset/nd_labeling_iris_data/PGGAN/1-fold/discriminator_{n_depth}_stabilize.png', show_shapes=True)
  pgan.compile(
      d_optimizer=discriminator_optimizer,
      g_optimizer=generator_optimizer,
  )

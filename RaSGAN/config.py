...
def load_args():
    ...
    parser.add_argument('-bs', '--batch_size', help="Data batch size.", default=2)
    parser.add_argument('-beta', help="Beta1 for the optimizer (0.5 default).", default=0.5)
    parser.add_argument('-nep', '--num_epochs', help="Number of training epochs.", default=300)
    ...
    parser.add_argument('-rp', '--results_path', help="Path for storing the results, it will generate the folders"
                        ...
                        default='E:/backup/ckp/GAN/rasgan/2/result')
    parser.add_argument('-tr_p', '--track_path',default='E:/backup/ckp/GAN/rasgan/2/tracking',

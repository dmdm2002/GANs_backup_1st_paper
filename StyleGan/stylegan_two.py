...
class StyleGAN(object):
    ...
    def evaluate(self, num = 0):
        ...
        x.save("E:/backup/StyleGAN/ND_2/2-fold/Results/i"+str(num)+".png")
        ...
        x.save("E:/backup/StyleGAN/ND_2/2-fold/Results/i"+str(num)+"-ema.png")
        ...
        x.save("E:/backup/StyleGAN/ND_2/2-fold/Results/i"+str(num)+"-mr.png")
    ...
    def generateTruncated(self, style, noi = np.zeros([44]), trunc = 0.5, outImage = False, num = 0):
        ...
        if outImage:
            ...
            x.save("E:/backup/StyleGAN/ND_2/2-fold/Results/t"+str(num)+".png")

        return generated_images

    def saveModel(self, model, name, num):
        json = model.to_json()
        with open("E:/backup/StyleGAN/ND_2/2-fold/Models/"+name+".json", "w") as json_file:
            json_file.write(json)

        model.save_weights("E:/backup/StyleGAN/ND_2/2-fold/Models/"+name+"_"+str(num)+".h5")

    def loadModel(self, name, num):

        file = open("E:/backup/StyleGAN/ND_2/2-fold/Models/"+name+".json", 'r')
        json = file.read()
        file.close()

        mod = model_from_json(json, custom_objects = {'Conv2DMod': Conv2DMod})
        mod.load_weights("E:/backup/StyleGAN/ND_2/2-fold/Models/"+name+"_"+str(num)+".h5")

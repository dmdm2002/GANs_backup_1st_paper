...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', type=str, default='D:/ND/original/A', help='path of resource dataset, should be a folder that has one or many sub image folders inside')
    parser.add_argument('--cuda', type=int, default=0, help='index of gpu to use')
    parser.add_argument('--name', type=str, default='1-fold', help='experiment name')

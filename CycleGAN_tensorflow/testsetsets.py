...
py.arg('--epochs', type=int, default=1000000000000)
py.arg('--epoch_decay', type=int, default=120)  # epoch to start decaying learning rate
...
# output_dir
output_dir = py.join('D:/cyclegan/output_interclass_shuffle_2fold(B)_2', args.dataset)
py.mkdir(output_dir)
...
img_folders = py.glob(py.join(args.datasets_dir, args.dataset, 'real'), '*')


A2B_pool = data.ItemPool(args.pool_size)
B2A_pool = data.ItemPool(args.pool_size)
#test
test_img_folders = py.glob(py.join(args.datasets_dir, args.dataset, 'real'), '*')
...
A_B_dataset_test, _ = data.make_zip_dataset(A_img_paths_test, B_img_paths_test, args.batch_size, args.load_size, args.crop_size, training=True,shuffle=False,repeat=True)
